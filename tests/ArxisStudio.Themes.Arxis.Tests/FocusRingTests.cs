...
/// <summary>
/// Кольцо фокуса: видно с клавиатуры, не видно после щелчка.
/// </summary>
/// <remarks>
...
public class FocusRingTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Галерею должно быть можно пройти без мыши. Здесь тот же проход по
    ...
    /// считается первым пикселем контура, а снаружи ложится второй. У
    /// контрола без рамки — флажка, тумблера,
    ...
    /// выбранный сегмент залит акцентом. Найдено живьём, на
