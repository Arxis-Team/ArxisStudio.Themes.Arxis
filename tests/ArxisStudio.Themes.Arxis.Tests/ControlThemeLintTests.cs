...
public class ControlThemeLintTests
{
    ...
    public static TheoryData<Type, string[]> Interactive => new()
    {
        ...
        { typeof(AxListBoxItem), [":pointerover", ":selected", ":disabled", ":focus-visible"] },
        { typeof(AxComboBoxItem), [":pointerover", ":selected", ":disabled", ":focus-visible"] },
        { typeof(AxTreeViewItem), [":pointerover", ":selected", ":disabled", ":focus-visible"] },
        { typeof(AxTabItem), [":pointerover", ":selected", ":disabled", ":focus-visible"] },
