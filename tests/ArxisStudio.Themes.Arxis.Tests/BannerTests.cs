...
/// <summary>
/// Баннер: размеры, крестик и цвет действия.
/// </summary>
/// <remarks>
/// Полоса растёт по содержимому — отступ 8 сверху и снизу, 12 по бокам,
...
///
/// Цель нажатия крестика — 24, меньше не бывает, но распирать
/// полосу ей нельзя: отрицательные отступы держат высоту по содержимому.
/// </remarks>
public class BannerTests
{
    [AvaloniaFact]
    public void Banner_keeps_its_geometry()
    {
