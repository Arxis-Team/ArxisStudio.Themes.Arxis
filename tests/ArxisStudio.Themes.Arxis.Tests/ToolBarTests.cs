...
/// </summary>
/// <remarks>
/// Иконочная кнопка — 24 на 24, и размер проверяет
/// <see cref="ControlGeometryTests"/>. Здесь остаются состояния: заливки
/// наведения, нажатия и включённости и то, что глиф идёт за ними.
///
...
public class ToolBarTests
{
    ...
    /// темы и кнопки окна. В сетке левый блок заперт в своей
    ...
    /// </summary>
    /// <remarks>
    /// Набор нарисован в клетке 16×16 с обводкой 1.2, а класс small с его
    /// двенадцатью заведён под мелкий шеврон в тесной строке.
    ...
    public void Window_button_glyphs_are_ordinary_icons()
    {
        ...
        foreach (var glyph in glyphs)
        {
            ...
            // занимает самая мелкая из фигур кнопок окна, квадрат.
            Assert.True(
