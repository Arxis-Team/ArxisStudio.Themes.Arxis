...
/// моношрифт отдан коду, путям и значениям, а «Shift F10» — ни то, ни
/// другое.
///
...
/// дерева контролов. Кегль — базовый.
/// </remarks>
public class CodeSampleTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Моношрифт остаётся коду, путям и значениям, а клавиши стоят обычным
    /// шрифтом.
    /// </remarks>
    [AvaloniaFact]
    ...
    public void Code_is_set_in_the_mono_face_at_the_base_size()
    {
        ...
        Assert.True(text.LineHeight is > 19.99 and <= 20, $"строка кода {text.LineHeight}, а должно быть 20 и не больше");
