...
/// </summary>
/// <remarks>
/// Строки стоят лестницей 8 → 26 → 44 от левого края панели. Шаг 18 — это
/// ровно шеврон 12 с зазором 6, и потому у строки без детей колонки шеврона
/// нет вовсе: значок файла встаёт на его
/// место. Пустая колонка увела бы все файлы на 18 вправо, и лестница
/// разъехалась бы.
///
...
public class TreeViewTests
{
    ...
    /// <summary>
    /// Лестница: 8 у корня, 26 на первом уровне, 44 на втором.
    /// </summary>
    /// <remarks>
