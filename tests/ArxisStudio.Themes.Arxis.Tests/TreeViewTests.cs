...
/// </summary>
/// <remarks>
/// Строки стоят лестницей 8 → 28 → 48 от левого края панели. Шаг — AxTreeIndent,
/// и это клетка шеврона целиком: шеврон 12 стоит в ней по центру. У строки без
/// детей колонки шеврона нет вовсе — значок файла встаёт на его место; пустая
/// колонка увела бы все файлы на шаг вправо, и лестница разъехалась бы.
///
/// Высота строки — AxRowHeight: у строки списка и строки дерева она одна.
/// </remarks>
public class TreeViewTests
{
    /// <summary>Строка дерева — AxRowHeight, та же, что у строки списка.</summary>
    [AvaloniaFact]
    ...
    /// <summary>
    /// Лестница: 8 у корня, 28 на первом уровне, 48 на втором.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>Заливка вставлена от краёв панели на 2.</summary>
    [AvaloniaFact]
