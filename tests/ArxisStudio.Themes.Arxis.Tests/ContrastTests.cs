...
public class ContrastTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Плашка — наведённая строка, выбранная строка, приподнятая плашка, сообщение. Обычная ссылка
    ...
    /// </summary>
    /// <remarks>
    /// Полоса выбранной вкладки в активной панели, дорожка хода, каретка — на поверхностях;
