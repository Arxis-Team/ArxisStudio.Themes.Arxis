...
/// отступала от края на 8, а ползунок живёт в полосе шириной 12. Полоса, которая отнимает ширину,
/// этого не знает — до неё строка не доходит, — а полоса поверх строк знает.
/// </remarks>
