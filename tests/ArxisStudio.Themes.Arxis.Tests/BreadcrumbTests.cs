...
public class BreadcrumbTests
{
    ...
    /// зависит; погашенный путь гаснет целиком, вместе с шевронами.
    /// </remarks>
    [AvaloniaTheory]
    [InlineData("Light")]
    [InlineData("Dark")]
    ...
    /// </summary>
    /// <remarks>
    /// Высота и радиус — AxControlHeight и AxCornerRadius. Отбивка 4 вместе с
    /// шестёркой звена даёт 10 до первой подписи.
    /// </remarks>
    [AvaloniaTheory]
    [InlineData("Light")]
    [InlineData("Dark")]
