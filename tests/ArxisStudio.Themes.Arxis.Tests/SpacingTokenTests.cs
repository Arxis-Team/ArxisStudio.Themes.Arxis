...
/// </summary>
/// <remarks>
/// Шкала расстояний принята темой, а не снята с чужих чисел, поэтому этот
/// файл и есть запись решения, а не его пересказ.
///
...
public class SpacingTokenTests
{
    ...
    [
        ...
        ("AxSpaceHairAboveThickness", 0, 2, 0, 0),
    ...
    [
        ...
        ("AxSpaceSidesThickness", 8, 0),
        ("AxSpaceLooseSidesThickness", 16, 0),
        ("AxSpaceEndsThickness", 0, 8),
    ];
