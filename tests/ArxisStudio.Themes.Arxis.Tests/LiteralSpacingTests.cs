...
public class LiteralSpacingTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Опускается коммитом миграции — вместе с файлом, из которого числа ушли,
    /// и записью в плане. Не поднимается ничем: отступ, которому не нашлось
