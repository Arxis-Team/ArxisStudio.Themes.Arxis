...
/// <summary>
/// Примитивы: аватар, ползунок, карточка-контейнер и бейдж.
/// </summary>
/// <remarks>
/// Аватар, ползунок, карточка-контейнер и бейдж — простые примитивы, и
/// проверять у них почти нечего, кроме одного решения про монограммы, — оно
/// проверяется здесь.
/// </remarks>
