...
Высота контрола с подписью — наименьшая, а не прибитая: 28 у кнопки, 34 у
вкладки, 40 у полосы заголовка — это их высоты при кегле темы. Вырастет кегль —
...
- `Metrics.axaml` — размеры: `AxControlHeight` и `AxControlHeightCompact`,
  `AxRowHeight`, `AxFocusOutlineWidth`, радиусы 3 / 4 / 6 / 8 / 10 / 12 и пилюля
...
поимённо; подпись каждого контрола цела при тройной шкале кеглей, а в обычной
контрол стоит на высоте спецификации; отступы и скругления числом сверяются
храповиками и только убывают.
